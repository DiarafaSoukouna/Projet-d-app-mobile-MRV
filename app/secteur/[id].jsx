...
export default function SecteurScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={{fontSize: 30, marginTop: 15, fontWeight: 500, marginLeft:15}}>Titre secteur</Text>
        ...
        <View style={styles.card}>
         <Text style={styles.text}> Secteur1</Text>
         ...
         <TouchableOpacity onPress={() => router.push(`../sous_secteur/${id}`)}>
